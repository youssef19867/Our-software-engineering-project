...
function saveProduct(button) {
 ...
 //
    ...
    xhr.send("productId=" + encodeURIComponent(productId) + "&name=" + encodeURIComponent(name) + "&quantity=" + encodeURIComponent(quantity) + "&price=" + encodeURIComponent(price) + "&expiry=" + encodeURIComponent(expiry));
